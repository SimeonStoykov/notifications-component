...
export default class Notification extends Component {
    ...
    render() {
        ...
        switch (this.props.data.type) {
            case 'text': {
                let { id, title, text } = this.props.data;
                notification =
                ...
                break;
            case 'promotion': {
                let { id, title, image, link } = this.props.data;

                notification =
                    <div key={id} className="notification-wrapper cursor-pointer" onClick={this.handlePromoNotificationCLick.bind(this, link)}>
                ...
                break;
            case 'bonus': {
                let { id, title, requirement } = this.props.data;
                notification =
                    <div key={id} className="notification-wrapper">
